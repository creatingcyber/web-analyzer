...
const timeoutErrorMsg =
  ...
  "in order to keep running costs affordable, so that Web Analyzer can " +
...
const disabledErrorMsg =
  ...
  "you can get Web Analyzer running on your own system, by following the instructions in our GitHub repo";
